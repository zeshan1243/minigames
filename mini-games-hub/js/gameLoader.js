...
const GAME_META = {
    reaction:      { title: 'Reaction Test',      hint: 'Click or tap when the screen turns green', module: './games/reaction.js' },
    snake:         { title: 'Snake',               hint: 'Arrow keys to move \u2022 Swipe on mobile \u2022 P to pause', module: './games/snake.js' },
    runner:        { title: 'Endless Runner',      hint: 'SPACE or tap to jump \u2022 P to pause', module: './games/runner.js' },
    stack:         { title: 'Stack Game',          hint: 'Click, tap, or SPACE to drop the block \u2022 P to pause', module: './games/stack.js' },
    puzzle:        { title: 'Daily Puzzle',        hint: 'Guess the daily number in 6 tries', module: './games/puzzle.js' },
    colormatch:    { title: 'Color Match',         hint: 'A/\u2190 = Match \u2022 D/\u2192 = Nope \u2022 or tap buttons', module: './games/colormatch.js' },
    whackamole:    { title: 'Whack-a-Mole',       hint: 'Click or tap the moles!', module: './games/whackamole.js' },
    aimtrainer:    { title: 'Aim Trainer',         hint: 'Click the targets before they disappear', module: './games/aimtrainer.js' },
    typing:        { title: 'Speed Typing',        hint: 'Type the falling words on your keyboard', module: './games/typing.js' },
    quickmath:     { title: 'Quick Math',          hint: 'Type the answer and press Enter', module: './games/quickmath.js' },
    tapcounter:    { title: 'Tap Counter',         hint: 'Tap or press SPACE as fast as you can!', module: './games/tapcounter.js' },
    simon:         { title: 'Simon Says',          hint: 'Watch the pattern, then tap it back', module: './games/simon.js' },
    catchball:     { title: 'Catch the Ball',      hint: 'Move paddle with mouse/touch/arrow keys', module: './games/catchball.js' },
    patternmemory: { title: 'Pattern Memory',     hint: 'Memorize the pattern, then tap the cells', module: './games/patternmemory.js' },
    breakout:      { title: 'Breakout',            hint: 'Mouse/touch to move paddle \u2022 Click/SPACE to launch \u2022 P to pause', module: './games/breakout.js' },
    pong:          { title: 'Pong',                hint: 'Mouse/touch/arrows to move paddle \u2022 P to pause', module: './games/pong.js' },
    flappy:        { title: 'Flappy Bird',         hint: 'SPACE or tap to flap \u2022 P to pause', module: './games/flappy.js' },
    asteroids:     { title: 'Asteroids',           hint: 'Arrows/WASD to steer \u2022 SPACE to shoot \u2022 P to pause', module: './games/asteroids.js' },
    spaceinvaders: { title: 'Space Invaders',      hint: 'Arrows to move \u2022 SPACE to shoot \u2022 P to pause', module: './games/spaceinvaders.js' },
    tetris:        { title: 'Tetris',              hint: 'Arrows to move/rotate \u2022 SPACE to drop \u2022 P to pause', module: './games/tetris.js' },
    doodlejump:    { title: 'Doodle Jump',         hint: 'Arrows/WASD to move \u2022 Tap sides on mobile \u2022 P to pause', module: './games/doodlejump.js' },
    game2048:      { title: '2048',                hint: 'Arrow keys or swipe to slide tiles', module: './games/game2048.js' },
    slidingpuzzle: { title: 'Sliding Puzzle',      hint: 'Click a tile next to the gap to slide it', module: './games/slidingpuzzle.js' },
    minesweeper:   { title: 'Minesweeper',         hint: 'Click to reveal \u2022 Right-click or long-press to flag', module: './games/minesweeper.js' },
    tictactoe:     { title: 'Tic-Tac-Toe',        hint: 'Click or tap a cell to place your X', module: './games/tictactoe.js' },
    connectfour:   { title: 'Connect Four',        hint: 'Click a column to drop your disc', module: './games/connectfour.js' },
    lightsout:     { title: 'Lights Out',          hint: 'Click a cell to toggle it and its neighbors', module: './games/lightsout.js' },
    pipeconnect:   { title: 'Pipe Connect',        hint: 'Click pipes to rotate them \u2022 Connect source to drain', module: './games/pipeconnect.js' },
    towerofhanoi:  { title: 'Tower of Hanoi',      hint: 'Click a peg to pick up/place discs \u2022 Keys 1-3', module: './games/towerofhanoi.js' },
    helicopter:    { title: 'Helicopter',           hint: 'Hold SPACE/click/tap to fly up \u2022 Release to descend', module: './games/helicopter.js' },
    ballbounce:    { title: 'Ball Bounce',          hint: 'Move paddle with mouse/touch/arrow keys', module: './games/ballbounce.js' },
    knifethrow:    { title: 'Knife Throw',          hint: 'SPACE or tap to throw the knife', module: './games/knifethrow.js' },
    archery:       { title: 'Archery',              hint: 'Hold SPACE/click to charge \u2022 Release to shoot', module: './games/archery.js' },
    darts:         { title: 'Darts',                hint: 'SPACE or tap to throw when crosshair is on target', module: './games/darts.js' },
    rhythmtap:     { title: 'Rhythm Tap',           hint: 'D/F/J/K keys or tap lanes when notes reach the line', module: './games/rhythmtap.js' },
    maze:          { title: 'Maze Runner',          hint: 'Arrow keys or swipe to navigate the maze', module: './games/maze.js' },
    colorfill:     { title: 'Color Fill',           hint: 'Click colors or press 1-6 to flood fill', module: './games/colorfill.js' },
    memorycards:   { title: 'Memory Cards',         hint: 'Click to flip cards \u2022 Match the pairs', module: './games/memorycards.js' },
    numbersort:    { title: 'Number Sort',          hint: 'Click adjacent numbers to swap them', module: './games/numbersort.js' },
    bubblepop:     { title: 'Bubble Pop',           hint: 'Click or tap bubbles to pop them', module: './games/bubblepop.js' },
    rps:           { title: 'Rock Paper Scissors',  hint: 'Click or press 1/2/3 to choose', module: './games/rps.js' },
    wordsearch:    { title: 'Word Search',          hint: 'Click and drag to select words', module: './games/wordsearch.js' },
    sudoku:        { title: 'Sudoku',               hint: 'Click a cell, then press 1-4 or use number pad', module: './games/sudoku.js' },
    golfputt:      { title: 'Golf Putt',            hint: 'Aim with mouse \u2022 Hold click to set power \u2022 Release to putt', module: './games/golfputt.js' },
    fruitslicer:   { title: 'Fruit Slicer',         hint: 'Click/drag across fruits to slice them', module: './games/fruitslicer.js' },
    platformer:    { title: 'Platformer',            hint: 'Arrows/WASD to move \u2022 SPACE to jump \u2022 Collect coins!', module: './games/platformer.js' },
